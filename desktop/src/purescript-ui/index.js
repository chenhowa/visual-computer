...
(function($PS) {
  ...
  var deleteState = function (state) {
      return function (start) {
          return function (end) {
              ...
              var $31 = end < Data_String_CodePoints.length(state.text);
              if ($31) {
                  return newState;
              };
              return newState;
  ...
  var getNewStateFromNonprintable = function (state) {
      return function (start) {
          return function (end) {
  ...
  var component = (function () {
      ...
      var handlePaste = function (ce) {
          ...
          var d = (function () {
              ...
              throw new Error("Failed pattern match at TextDisplay (line 169, column 21 - line 171, column 43): " + [ v.constructor.name ]);
          })();
      ...
      var handleModifiedKeyDown = function (event) {
          ...
          throw new Error("Failed pattern match at TextDisplay (line 150, column 9 - line 150, column 76): " + [ event.constructor.name ]);
      };
      ...
      var $$eval = function (q) {
          ...
          if (q instanceof UnmodifiedKeyDown) {
              var $43 = WhatUtils.isPrintable(q.value0);
              if ($43) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
                  var newState = getNewStateFromNonprintable(v)(q.value1)(q.value2)(q.value0);
          ...
          if (q instanceof Cut) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))((function () {
                      ...
                      throw new Error("Failed pattern match at TextDisplay (line 140, column 30 - line 142, column 41): " + [ q.value0.constructor.name ]);
                  })()))(function () {
          ...
          throw new Error("Failed pattern match at TextDisplay (line 103, column 18 - line 145, column 26): " + [ q.constructor.name ]);
      };
  ...
  exports["getNewStateFromNonprintable"] = getNewStateFromNonprintable;
