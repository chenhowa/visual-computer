...
(function($PS) {
  ...
  var propToStrKey = function (v) {
      ...
      throw new Error("Failed pattern match at Halogen.VDom.DOM.Prop (line 178, column 16 - line 183, column 16): " + [ v.constructor.name ]);
  };
...
(function($PS) {
  ...
  var prop = function (dictIsProp) {
      return function (v) {
          var $32 = Halogen_VDom_DOM_Prop.Property.create(v);
          var $33 = toPropValue(dictIsProp);
          return function ($34) {
              return $32($33($34));
          };
      };
...
(function($PS) {
  ...
  var mkQuery = function (dictEq) {
      return function (p) {
          var $176 = ChildQuery.create(p);
          var $177 = Data_Coyoneda.coyoneda(Control_Category.identity(Control_Category.categoryFn));
          return function ($178) {
              return HalogenM(Control_Monad_Free.liftF($176($177($178))));
          };
      };
  };
  ...
  var monadStateHalogenM = new Control_Monad_State_Class.MonadState(function () {
      ...
      return HalogenM(Control_Monad_Free.liftF(State.create($185)));
  });
  exports["State"] = State;
...
(function($PS) {
  ...
  var handler = function (et) {
      ...
      var $2 = Data_Functor.map(Data_Functor.functorFn)(Data_Functor.map(Data_Maybe.functorMaybe)(Halogen_Query_InputF.Query.create));
      return function ($3) {
          return $1($2($3));
      };
  };                                                       
  ...
  var onKeyDown = (function () {
      var $8 = handler(Web_UIEvent_KeyboardEvent_EventTypes.keydown);
      return function ($9) {
          return $8(keyHandler($9));
      };
  })();
  var clipboardHandler = Unsafe_Coerce.unsafeCoerce;
  var onCut = (function () {
      var $66 = handler(Web_Clipboard_ClipboardEvent_EventTypes.cut);
      return function ($67) {
          return $66(clipboardHandler($67));
      };
  })();
  var onPaste = (function () {
      var $68 = handler(Web_Clipboard_ClipboardEvent_EventTypes.paste);
      return function ($69) {
...
})(PS["RemoteElectron"] = PS["RemoteElectron"] || {});
(function($PS) {
  // Generated by purs version 0.13.0
  "use strict";
  $PS["RemoteElectron"] = $PS["RemoteElectron"] || {};
  var exports = $PS["RemoteElectron"];
  var $foreign = $PS["RemoteElectron"];
  exports["openFileDialog"] = $foreign.openFileDialog;
})(PS);
(function(exports) {
  "use strict";
  /* global Symbol */
...
(function($PS) {
  ...
  var classes = (function () {
      var $13 = prop(Halogen_HTML_Core.stringIsProp)("className");
      var $14 = Data_String_Common.joinWith(" ");
      var $15 = Data_Functor.map(Data_Functor.functorArray)(Data_Newtype.unwrap(Halogen_HTML_Core.newtypeClassName));
      return function ($16) {
          return $13($14($15($16)));
      };
  })();
...
(function($PS) {
  // Generated by purs version 0.13.0
  "use strict";
  $PS["WhatUtils"] = $PS["WhatUtils"] || {};
  var exports = $PS["WhatUtils"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Data_Ord = $PS["Data.Ord"];
  ...
  var validIndex = function (index) {
      return function (str) {
          return index >= 0 && index <= Data_String_CodePoints.length(str);
      };
  };
  var transformKey = function (str) {
      if (str === "Enter") {
          return "\x0a";
      };
      if (str === "Tab") {
  ...
  var pasteString = function (full) {
      return function (start) {
          return function (end) {
              return function (insert) {
                  var $8 = !validIndex(start)(full) || !validIndex(end)(full);
                  if ($8) {
                      return full;
                  };
                  var $9 = start !== end;
                  if ($9) {
                      var before = (Data_String_CodePoints.splitAt(start)(full)).before;
                      var after = (Data_String_CodePoints.splitAt(end)(full)).after;
                      return before + (insert + after);
                  };
                  var before = (Data_String_CodePoints.splitAt(start)(full)).before;
                  var after = (Data_String_CodePoints.splitAt(start)(full)).after;
                  return before + (insert + after);
              };
          };
      };
  };
  var isPrintable = function (str) {
      var isNotPrintable = function (s) {
          if (s === "Enter") {
              return false;
          };
          if (s === "Tab") {
      ...
      var $11 = Data_String_CodePoints.length(str) === 1;
      if ($11) {
          return true;
      };
      var $12 = isNotPrintable(str);
      if ($12) {
          return false;
      };
      return true;
  };
  var copyString = function (full) {
      return function (start) {
          return function (end) {
              var $13 = !validIndex(start)(full) || !validIndex(end)(full);
              if ($13) {
                  return "";
              };
              var $14 = start !== end;
              if ($14) {
                  return Data_String_CodePoints.take(end - start | 0)(Data_String_CodePoints.drop(start)(full));
              };
              return "";
          };
      };
  };
  var constructNewText = function (full) {
      return function (start) {
          return function (end) {
              return function (insert) {
                  var transformedInsert = transformKey(insert);
                  var $15 = start === end;
                  if ($15) {
                      return (Data_String_CodePoints.splitAt(start)(full)).before + (transformedInsert + (Data_String_CodePoints.splitAt(start)(full)).after);
                  };
                  return (Data_String_CodePoints.splitAt(start)(full)).before + (transformedInsert + (Data_String_CodePoints.splitAt(end)(full)).after);
              };
          };
      };
  };
  var classes = function (list) {
      return Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)(list));
  };
  var backspaceText = function (full) {
      return function (start) {
          return function (end) {
              var $16 = start === end;
              if ($16) {
                  var before = (Data_String_CodePoints.splitAt(start)(full)).before;
                  var after = (Data_String_CodePoints.splitAt(end)(full)).after;
                  var $17 = start > Data_String_CodePoints.length(full) || end < 0;
                  if ($17) {
                      return full;
                  };
                  return Data_String_CodePoints.take(Data_String_CodePoints.length(before) - 1 | 0)(before) + after;
              };
              return (Data_String_CodePoints.splitAt(start)(full)).before + (Data_String_CodePoints.splitAt(end)(full)).after;
          };
      };
  };
  var deleteText = function (full) {
      return function (start) {
          return function (end) {
              var $18 = start === end;
              if ($18) {
                  return backspaceText(full)(start + 1 | 0)(start + 1 | 0);
              };
              return (Data_String_CodePoints.splitAt(start)(full)).before + (Data_String_CodePoints.splitAt(end)(full)).after;
          };
      };
  };
  var arrowUpIndex = function (full) {
      return function (start) {
          return function (end) {
              var getNewStart = function (last) {
                  return function (lastLast) {
                      return function (offset) {
                          return Data_Ord.min(Data_Ord.ordInt)(last)(lastLast + offset | 0);
                      };
                  };
              };
              var getLastNewlineIndex = function (str) {
                  return Data_String_CodePoints.lastIndexOf("\x0a")(str);
              };
              var getLastLastNewlineIndex = function (first) {
                  return function (str) {
                      return Data_String_CodePoints.lastIndexOf("\x0a")((Data_String_CodePoints.splitAt(first)(str)).before);
                  };
              };
              var calculateOffset = function (index) {
              ...
              var $19 = start !== end;
              if ($19) {
                  return Data_Ord.min(Data_Ord.ordInt)(Data_Ord.max(Data_Ord.ordInt)(start)(0))(Data_String_CodePoints.length(full));
              };
              var before = (Data_String_CodePoints.splitAt(start)(full)).before;
              var maybeIndex = Control_Bind.bind(Data_Maybe.bindMaybe)(getLastNewlineIndex(before))(function (v) {
                  var lineOffset = calculateOffset(v)(Data_String_CodePoints.length(before));
                  var lastLastNewlineIndex = (function () {
                      var v1 = getLastLastNewlineIndex(v)(before);
                      if (v1 instanceof Data_Maybe.Nothing) {
                          return -1 | 0;
                      };
                      if (v1 instanceof Data_Maybe.Just) {
                      ...
                      throw new Error("Failed pattern match at WhatUtils (line 71, column 44 - line 73, column 50): " + [ v1.constructor.name ]);
                  })();
                  return Data_Maybe.Just.create(getNewStart(v)(lastLastNewlineIndex)(lineOffset));
              });
              if (maybeIndex instanceof Data_Maybe.Nothing) {
                  return 0;
              };
              if (maybeIndex instanceof Data_Maybe.Just) {
                  return maybeIndex.value0;
              };
              throw new Error("Failed pattern match at WhatUtils (line 75, column 12 - line 77, column 32): " + [ maybeIndex.constructor.name ]);
          };
      };
  };
  var arrowRightIndex = function (str) {
      return function (start) {
          return function (end) {
              var $25 = start !== end;
              if ($25) {
                  return Data_Ord.max(Data_Ord.ordInt)(0)(Data_Ord.min(Data_Ord.ordInt)(end)(Data_String_CodePoints.length(str)));
              };
              return Data_Ord.max(Data_Ord.ordInt)(0)(Data_Ord.min(Data_Ord.ordInt)(end + 1 | 0)(Data_String_CodePoints.length(str)));
          };
      };
  };
  var arrowLeftIndex = function (str) {
      return function (start) {
          return function (end) {
              var $26 = start !== end;
              if ($26) {
                  return Data_Ord.min(Data_Ord.ordInt)(Data_String_CodePoints.length(str))(Data_Ord.max(Data_Ord.ordInt)(start)(0));
              };
              return Data_Ord.min(Data_Ord.ordInt)(Data_String_CodePoints.length(str))(Data_Ord.max(Data_Ord.ordInt)(start - 1 | 0)(0));
          };
      };
  };
  var arrowDownIndex = function (full) {
      return function (start) {
          return function (end) {
              var getNextNextNewlineIndex = function (current) {
                  return function (str) {
                      var after = (Data_String_CodePoints.splitAt(current + 1 | 0)(str)).after;
                      var v = Data_String_CodePoints.indexOf("\x0a")(after);
                      if (v instanceof Data_Maybe.Nothing) {
                          return Data_Maybe.Nothing.value;
                      };
                      if (v instanceof Data_Maybe.Just) {
                          return Data_Maybe.Just.create((current + 1 | 0) + v.value0 | 0);
                      };
                      throw new Error("Failed pattern match at WhatUtils (line 129, column 17 - line 131, column 61): " + [ v.constructor.name ]);
                  };
              };
              var getNextNewlineIndex = function (current) {
                  return function (str) {
                      var after = (Data_String_CodePoints.splitAt(current)(str)).after;
                      var v = Data_String_CodePoints.indexOf("\x0a")(after);
                      if (v instanceof Data_Maybe.Nothing) {
                          return Data_Maybe.Nothing.value;
                      };
                      if (v instanceof Data_Maybe.Just) {
                          return Data_Maybe.Just.create(current + v.value0 | 0);
                      };
                      throw new Error("Failed pattern match at WhatUtils (line 122, column 17 - line 124, column 57): " + [ v.constructor.name ]);
                  };
              };
              var getNewEnd = function (next) {
                  return function (nextNext) {
                      return function (offset) {
                          return Data_Ord.min(Data_Ord.ordInt)(nextNext)(next + offset | 0);
                      };
                  };
              };
              var getLastNewlineIndex = function (str) {
              ...
              var $31 = start !== end;
              if ($31) {
                  return Data_Ord.max(Data_Ord.ordInt)(Data_Ord.min(Data_Ord.ordInt)(end)(Data_String_CodePoints.length(full)))(0);
              };
              var split = Data_String_CodePoints.splitAt(end)(full);
              var maybeIndex = (function () {
                  var lastNewlineIndex = (function () {
                      var v = getLastNewlineIndex(split.before);
                      if (v instanceof Data_Maybe.Nothing) {
                          return -1 | 0;
                      };
                      if (v instanceof Data_Maybe.Just) {
                      ...
                      throw new Error("Failed pattern match at WhatUtils (line 100, column 40 - line 102, column 36): " + [ v.constructor.name ]);
                  })();
                  var lineOffset = calculateOffset(lastNewlineIndex)(Data_String_CodePoints.length(split.before));
                  return Control_Bind.bind(Data_Maybe.bindMaybe)(getNextNewlineIndex(end)(full))(function (v) {
                      var nextNextNewlineIndex = (function () {
                          var v1 = getNextNextNewlineIndex(v)(full);
                          if (v1 instanceof Data_Maybe.Nothing) {
                              return Data_String_CodePoints.length(full);
                          };
                          if (v1 instanceof Data_Maybe.Just) {
                              return v1.value0;
                          };
                          throw new Error("Failed pattern match at WhatUtils (line 105, column 44 - line 107, column 50): " + [ v1.constructor.name ]);
                      })();
                      return Data_Maybe.Just.create(getNewEnd(v)(nextNextNewlineIndex)(lineOffset));
                  });
              })();
              if (maybeIndex instanceof Data_Maybe.Nothing) {
                  return Data_String_CodePoints.length(full);
              ...
              throw new Error("Failed pattern match at WhatUtils (line 109, column 12 - line 111, column 32): " + [ maybeIndex.constructor.name ]);
          };
      };
  };
  exports["classes"] = classes;
  exports["constructNewText"] = constructNewText;
  exports["transformKey"] = transformKey;
  exports["isPrintable"] = isPrintable;
  exports["backspaceText"] = backspaceText;
  exports["deleteText"] = deleteText;
  exports["arrowUpIndex"] = arrowUpIndex;
  exports["arrowDownIndex"] = arrowDownIndex;
  exports["arrowLeftIndex"] = arrowLeftIndex;
  exports["arrowRightIndex"] = arrowRightIndex;
...
(function($PS) {
  // Generated by purs version 0.13.0
  "use strict";
  $PS["FileLoad"] = $PS["FileLoad"] || {};
  var exports = $PS["FileLoad"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  var Data_Function = $PS["Data.Function"];
  ...
  var Halogen_Query_HalogenM = $PS["Halogen.Query.HalogenM"];
  var RemoteElectron = $PS["RemoteElectron"];
  ...
  var component = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div([ WhatUtils.classes([ "file-load-component" ]) ])([ Halogen_HTML_Elements.button([ WhatUtils.classes([ "file-load-button" ]), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Click.create)) ])([ Halogen_HTML_Core.text(state) ]) ]);
      };
      var $$eval = function (q) {
          var file = RemoteElectron.openFileDialog(Data_Unit.unit);
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(file))(function () {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(q.value0);
          });
      };
      return Halogen_Component.component(Halogen_HTML_Core.bifunctorHTML)({
          initialState: Data_Function["const"]("File1"),
          render: render,
          "eval": $$eval,
          ...
          return function (component) {
              return function (input) {
                  return function (outputQuery) {
                      ...
                      var f = (function () {
                          var $2 = Data_Functor.map(Data_Maybe.functorMaybe)(Halogen_Component_ChildPath.injQuery(i));
                          var $3 = Halogen_Component.unComponent(function (v) {
                              return v.receiver;
                          })(component);
                          return function ($4) {
                              return $2($3($4));
...
(function($PS) {
  // Generated by purs version 0.13.0
  "use strict";
  $PS["ResetButton"] = $PS["ResetButton"] || {};
  var exports = $PS["ResetButton"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  var Data_Function = $PS["Data.Function"];
  ...
  var render = function (state) {
      var label = "RESET" + (" " + Data_Show.show(Data_Show.showInt)(state));
      return Halogen_HTML_Elements.button([ Halogen_HTML_Properties.title(label), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Click.create)), Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "reset-button-component" ])) ])([ Halogen_HTML_Core.text(label) ]);
  };
  var initialState = 0;
  var $$eval = function (q) {
      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
          ...
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(nextState))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(new Clicked(nextState)))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(q.value0);
              });
          });
      });
...
(function($PS) {
  // Generated by purs version 0.13.0
  "use strict";
  $PS["SpeedAdjustment"] = $PS["SpeedAdjustment"] || {};
  var exports = $PS["SpeedAdjustment"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Data_Function = $PS["Data.Function"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_Maybe = $PS["Data.Maybe"];
  ...
  var SetSlow = (function () {
      function SetSlow(value0) {
          this.value0 = value0;
      };
      SetSlow.create = function (value0) {
          return new SetSlow(value0);
      };
      return SetSlow;
  })();
  var SetMedium = (function () {
      function SetMedium(value0) {
          this.value0 = value0;
      };
      SetMedium.create = function (value0) {
          return new SetMedium(value0);
      };
      return SetMedium;
  })();
  var SetFast = (function () {
      function SetFast(value0) {
          this.value0 = value0;
      };
      SetFast.create = function (value0) {
          return new SetFast(value0);
      };
      return SetFast;
  })();
  var renderSpeedSetting = function (name) {
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "speed-setting" ])) ])([  ]);
  };
  var component = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "speed-adjustment-component" ])) ])([ renderSpeedSetting(state), renderSpeedSetting(state), renderSpeedSetting(state) ]);
      };
      var $$eval = function (q) {
          if (q instanceof SetSlow) {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(q.value0);
          };
          if (q instanceof SetMedium) {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(q.value0);
          };
          if (q instanceof SetFast) {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(q.value0);
          };
          throw new Error("Failed pattern match at SpeedAdjustment (line 63, column 18 - line 66, column 38): " + [ q.constructor.name ]);
      };
      return Halogen_Component.component(Halogen_HTML_Core.bifunctorHTML)({
          initialState: Data_Function["const"](Medium.value),
          render: render,
          "eval": $$eval,
          receiver: Data_Function["const"](Data_Maybe.Nothing.value)
      });
  ...
  exports["component"] = component;
  exports["renderSpeedSetting"] = renderSpeedSetting;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.0
  "use strict";
  $PS["ActionMenu"] = $PS["ActionMenu"] || {};
  var exports = $PS["ActionMenu"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Data_Either = $PS["Data.Either"];
  var Data_Function = $PS["Data.Function"];
  var Data_Functor = $PS["Data.Functor"];
  ...
  var Halogen_HTML_Properties = $PS["Halogen.HTML.Properties"];
  var Halogen_Query_HalogenM = $PS["Halogen.Query.HalogenM"];
  var ResetButton = $PS["ResetButton"];
  var SpeedAdjustment = $PS["SpeedAdjustment"];
  var WhatUtils = $PS["WhatUtils"];
  var speedSlot = Halogen_Component_ChildPath.cp2;
  var resetSlot = Halogen_Component_ChildPath.cp1;
  var initialState = Data_Unit.unit;
  var fileLoadSlot = Halogen_Component_ChildPath.cp3;
  var render = function (state) {
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "action-menu-component" ])) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "action-menu-item" ])) ])([ Halogen_HTML["slot'"](resetSlot)(Data_Unit.unit)(ResetButton.component)(Data_Unit.unit)(Data_Function["const"](Data_Maybe.Nothing.value)) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "action-menu-item" ])) ])([ Halogen_HTML["slot'"](speedSlot)(Data_Unit.unit)(SpeedAdjustment.component)(Data_Unit.unit)(Data_Function["const"](Data_Maybe.Nothing.value)) ]), Halogen_HTML_Elements.div([ WhatUtils.classes([ "action-menu-item" ]) ])([ Halogen_HTML["slot'"](fileLoadSlot)(Data_Unit.unit)(FileLoad.component)(Data_Unit.unit)(Data_Function["const"](Data_Maybe.Nothing.value)) ]) ]);
  };
  var $$eval = function (q) {
      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(q.value0);
  };
  var component = Halogen_Component.parentComponent(Data_Either.ordEither(Data_Ord.ordUnit)(Data_Either.ordEither(Data_Ord.ordUnit)(Data_Either.ordEither(Data_Ord.ordUnit)(Data_Ord.ordVoid))))({
      initialState: Data_Function["const"](initialState),
      render: render,
      "eval": $$eval,
      receiver: Data_Function["const"](Data_Maybe.Nothing.value)
  ...
  exports["initialState"] = initialState;
  exports["render"] = render;
  exports["resetSlot"] = resetSlot;
  exports["speedSlot"] = speedSlot;
  exports["fileLoadSlot"] = fileLoadSlot;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.0
  "use strict";
...
})(PS["Events.UI"] = PS["Events.UI"] || {});
(function($PS) {
  // Generated by purs version 0.13.0
  "use strict";
  $PS["Events.UI"] = $PS["Events.UI"] || {};
  var exports = $PS["Events.UI"];
  var $foreign = $PS["Events.UI"];
  var Data_Maybe = $PS["Data.Maybe"];                
  var target = function (str) {
      var t = $foreign.maybeTarget(str);
      var $1 = $foreign.isUndefined(t);
      if ($1) {
          return Data_Maybe.Nothing.value;
      };
      return Data_Maybe.Just.create($foreign.unsafeGetDefined(t));
  };
  var onTripleClick = function (self) {
      return function (fn) {
          return $foreign.onTripleClickImpl(self, function (v) {
              return fn;
          });
      };
  };
  exports["onTripleClick"] = onTripleClick;
  ...
  var produce = function (recv) {
      return produceAff(Effect_Aff_Class.monadAffAff)(function (send) {
          return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(recv((function () {
              var $52 = Data_Functor["void"](Effect.functorEffect);
              return function ($53) {
                  return $52(runAff$prime(send($53)));
              };
          })()));
      });
  };
...
(function($PS) {
  // Generated by purs version 0.13.0
  "use strict";
  $PS["TextDisplayLine"] = $PS["TextDisplayLine"] || {};
  var exports = $PS["TextDisplayLine"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  var Halogen_Component = $PS["Halogen.Component"];
...
})(PS["TextSelection"] = PS["TextSelection"] || {});
(function($PS) {
  // Generated by purs version 0.13.0
  "use strict";
  $PS["TextSelection"] = $PS["TextSelection"] || {};
  var exports = $PS["TextSelection"];
  var $foreign = $PS["TextSelection"];
  exports["startIndex"] = $foreign.startIndex;
  exports["endIndex"] = $foreign.endIndex;
  exports["setSelection"] = $foreign.setSelection;
})(PS);
(function(exports) {
  "use strict";
...
(function($PS) {
  ...
  var $foreign = $PS["Web.Clipboard.ClipboardEvent"];
  var Data_Nullable = $PS["Data.Nullable"];
  var Unsafe_Coerce = $PS["Unsafe.Coerce"];                      
...
(function($PS) {
  "use strict";
  $PS["TextDisplay"] = $PS["TextDisplay"] || {};
  var exports = $PS["TextDisplay"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  var Data_Array = $PS["Data.Array"];
  ...
  var Halogen_Query_HalogenM = $PS["Halogen.Query.HalogenM"];
  var TextDisplayLine = $PS["TextDisplayLine"];
  var TextSelection = $PS["TextSelection"];
  ...
  var WhatUtils = $PS["WhatUtils"];                
  var LineSlot = (function () {
      function LineSlot(value0) {
          this.value0 = value0;
      };
      LineSlot.create = function (value0) {
          return new LineSlot(value0);
      };
      return LineSlot;
  })();
  var UnmodifiedKeyDown = (function () {
      function UnmodifiedKeyDown(value0, value1, value2, value3) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
          this.value3 = value3;
      };
      UnmodifiedKeyDown.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return function (value3) {
                      return new UnmodifiedKeyDown(value0, value1, value2, value3);
                  };
              };
          };
      };
      return UnmodifiedKeyDown;
  })();
  var GeneralKeyDown = (function () {
      function GeneralKeyDown(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      GeneralKeyDown.create = function (value0) {
          return function (value1) {
              return new GeneralKeyDown(value0, value1);
          };
      };
      return GeneralKeyDown;
  })();
  ...
  var Paste = (function () {
      function Paste(value0, value1, value2, value3) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
          this.value3 = value3;
      };
      Paste.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return function (value3) {
                      return new Paste(value0, value1, value2, value3);
                  };
              };
          };
      };
  ...
  var Cut = (function () {
      function Cut(value0, value1, value2, value3) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
          this.value3 = value3;
      };
      Cut.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return function (value3) {
                      return new Cut(value0, value1, value2, value3);
                  };
              };
          };
      };
  ...
  var HandleTripleClick = (function () {
      function HandleTripleClick(value0) {
          this.value0 = value0;
      };
      HandleTripleClick.create = function (value0) {
          return new HandleTripleClick(value0);
      };
  ...
  var TextChanged = (function () {
      ...
      TextChanged.value = new TextChanged();
      return TextChanged;
  })();
  var NonprintableKey = (function () {
      function NonprintableKey() {

      };
      NonprintableKey.value = new NonprintableKey();
      return NonprintableKey;
  })();
  var pasteState = function (state) {
      return function (start) {
          return function (end) {
              return function (insert) {
                  var newEnd = start + Data_String_CodePoints.length(insert) | 0;
                  var newState = {
                      text: WhatUtils.pasteString(state.text)(start)(end)(insert),
  ...
  var newStateFromPrintable = function (state) {
      return function (start) {
          return function (end) {
              return function (newChar) {
                  var newText = WhatUtils.constructNewText(state.text)(start)(end)(newChar);
                  return {
                      text: newText,
                      selectionStart: start + 1 | 0,
                      selectionEnd: start + 1 | 0
                  };
              };
          };
      };
  };
  var eqTextLineSlot = new Data_Eq.Eq(function (x) {
      return function (y) {
          return x.value0 === y.value0;
      };
  });
  var ordTextLineSlot = new Data_Ord.Ord(function () {
      return eqTextLineSlot;
  }, function (x) {
      return function (y) {
  ...
  var deleteState = function (state) {
      return function (start) {
          return function (end) {
              var newText = WhatUtils.deleteText(state.text)(start)(end);
              var newState = {
                  text: newText,
                  selectionStart: start,
                  selectionEnd: start
              };
              var $33 = end < Data_String_CodePoints.length(state.text);
              if ($33) {
                  return newState;
              };
              return newState;
  ...
  var cutState = function (state) {
      return function (start) {
          return function (end) {
              var newState = {
                  text: WhatUtils.backspaceText(state.text)(start)(end),
                  selectionStart: start,
                  selectionEnd: start
              };
              return newState;
  ...
  var backspaceState = function (state) {
      return function (start) {
          return function (end) {
              var newText = WhatUtils.backspaceText(state.text)(start)(end);
              var $34 = start > 0;
              if ($34) {
                  return {
                      text: newText,
  ...
  var arrowUpState = function (state) {
      return function (start) {
          return function (end) {
              var newStart = WhatUtils.arrowUpIndex(state.text)(start)(end);
              return {
                  text: state.text,
  ...
  var arrowRightState = function (state) {
      return function (start) {
          return function (end) {
              var newEnd = WhatUtils.arrowRightIndex(state.text)(start)(end);
              return {
                  text: state.text,
                  selectionStart: newEnd,
                  selectionEnd: newEnd
  ...
  var arrowLeftState = function (state) {
      return function (start) {
          return function (end) {
              var newStart = WhatUtils.arrowLeftIndex(state.text)(start)(end);
              return {
                  text: state.text,
                  selectionStart: newStart,
                  selectionEnd: newStart
  ...
  var arrowDownState = function (state) {
      return function (start) {
          return function (end) {
              var newEnd = WhatUtils.arrowDownIndex(state.text)(start)(end);
              return {
                  text: state.text,
                  selectionStart: newEnd,
                  selectionEnd: newEnd
  ...
  var newStateFromNonprintable = function (state) {
      return function (start) {
          return function (end) {
              return function (nonprintable) {
                  if (nonprintable === "ArrowRight") {
                      return arrowRightState(state)(start)(end);
                  };
                  if (nonprintable === "ArrowLeft") {
                      return arrowLeftState(state)(start)(end);
                  };
                  if (nonprintable === "ArrowUp") {
                      return arrowUpState(state)(start)(end);
                  };
                  if (nonprintable === "ArrowDown") {
                      return arrowDownState(state)(start)(end);
                  };
                  if (nonprintable === "Backspace") {
                      return backspaceState(state)(start)(end);
                  };
                  if (nonprintable === "Delete") {
                      return deleteState(state)(start)(end);
                  };
                  return state;
              };
          };
  ...
  var component = (function () {
      var isModified = function (event) {
          return Web_UIEvent_KeyboardEvent.ctrlKey(event) || (Web_UIEvent_KeyboardEvent.altKey(event) || Web_UIEvent_KeyboardEvent.metaKey(event));
      };
      var initialState = {
          text: "DEFAUL\x0aTTTO12345\x0ajklj",
          selectionStart: 0,
          selectionEnd: 5
      };
      var handleUnmodifiedKeyDown = function (event) {
          var start = TextSelection.startIndex("text-editor-component");
          var key = Web_UIEvent_KeyboardEvent.key(event);
          var end = TextSelection.endIndex("text-editor-component");
          var code = Web_UIEvent_KeyboardEvent.code(event);
          return UnmodifiedKeyDown.create(key)(Data_Ord.min(Data_Ord.ordInt)(start)(end))(Data_Ord.max(Data_Ord.ordInt)(start)(end));
      };
      var handlePaste = function (ce) {
          var start = TextSelection.startIndex("text-editor-component");
          var end = TextSelection.endIndex("text-editor-component");
          var d = (function () {
              var v = Web_Clipboard_ClipboardEvent.clipboardData(ce);
              if (v instanceof Data_Maybe.Just) {
                  return Web_HTML_Event_DataTransfer.getData(Data_MediaType_Common.textPlain)(v.value0);
              };
              if (v instanceof Data_Maybe.Nothing) {
                  return Control_Applicative.pure(Effect.applicativeEffect)("");
              };
              throw new Error("Failed pattern match at TextDisplay (line 182, column 21 - line 184, column 43): " + [ v.constructor.name ]);
          })();
          return Paste.create(d)(Data_Ord.min(Data_Ord.ordInt)(start)(end))(Data_Ord.max(Data_Ord.ordInt)(start)(end));
      };
      var handleModifiedKeyDown = function (event) {
          if (Data_Boolean.otherwise) {
              return NoOp.create;
          };
          throw new Error("Failed pattern match at TextDisplay (line 163, column 9 - line 163, column 76): " + [ event.constructor.name ]);
      };
      var handleGeneralKeyDown = function (ke) {
          return GeneralKeyDown.create(ke);
      };
      var handleCut = function (ce) {
          var start = TextSelection.startIndex("text-editor-component");
          var end = TextSelection.endIndex("text-editor-component");
          var d = Web_Clipboard_ClipboardEvent.clipboardData(ce);
          return Cut.create(d)(Data_Ord.min(Data_Ord.ordInt)(start)(end))(Data_Ord.max(Data_Ord.ordInt)(start)(end));
      };
      var render = function (state) {
          ...
          return Halogen_HTML_Elements.div([ WhatUtils.classes([ "text-display-component" ]), Halogen_HTML_Properties.title("HI"), Halogen_HTML_Properties.attr("contenteditable")("true"), Halogen_HTML_Events.onKeyDown(Halogen_HTML_Events.input(handleGeneralKeyDown)), Halogen_HTML_Events.onPaste(function (e) {
              return Data_Maybe.Just.create(PreventDefault.create(Web_Clipboard_ClipboardEvent.toEvent(e))(Halogen_Query.action(handlePaste(e))));
          }), Halogen_HTML_Events.onCut(function (e) {
              return Data_Maybe.Just.create(PreventDefault.create(Web_Clipboard_ClipboardEvent.toEvent(e))(Halogen_Query.action(handleCut(e))));
          }) ])(children);
      };
      var $$eval = function (q) {
          if (q instanceof Initialize) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Console.log((function () {
                  var v = Events_UI.target("text-display-component");
                  if (v instanceof Data_Maybe.Just) {
                      return "found target";
                  };
                  if (v instanceof Data_Maybe.Nothing) {
                  ...
                  throw new Error("Failed pattern match at TextDisplay (line 108, column 36 - line 110, column 59): " + [ v.constructor.name ]);
              })())))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      var v = Events_UI.target("text-display-component");
                      if (v instanceof Data_Maybe.Just) {
                          return Halogen_Query_HalogenM.subscribe(Halogen_Query_EventSource.eventSource_(Effect_Aff_Class.monadAffAff)(Events_UI.onTripleClick(v.value0))(Halogen_Query.request(HandleTripleClick.create)));
                      };
                      if (v instanceof Data_Maybe.Nothing) {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                      };
                      throw new Error("Failed pattern match at TextDisplay (line 111, column 17 - line 113, column 45): " + [ v.constructor.name ]);
                  })())(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(q.value0);
                  });
              });
          };
          if (q instanceof GeneralKeyDown) {
              var $47 = isModified(q.value0);
              if ($47) {
                  return $$eval(handleModifiedKeyDown(q.value0)(q.value1));
              };
              return $$eval(PreventDefault.create(Web_UIEvent_KeyboardEvent.toEvent(q.value0))(handleUnmodifiedKeyDown(q.value0)(q.value1)));
          };
          if (q instanceof UnmodifiedKeyDown) {
              var $50 = WhatUtils.isPrintable(q.value0);
              if ($50) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(newStateFromPrintable(v)(q.value1)(q.value2)(q.value0)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(TextChanged.value))(function () {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(q.value3);
                          });
                      });
                  });
              };
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
                  var newState = newStateFromNonprintable(v)(q.value1)(q.value2)(q.value0);
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(newState))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(NonprintableKey.value))(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(q.value3);
                      });
                  });
              });
          };
          if (q instanceof PreventDefault) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_Event_Event.preventDefault(q.value0)))(function () {
                  return $$eval(q.value1);
              });
          };
          if (q instanceof NoOp) {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(q.value0);
          };
          if (q instanceof Click) {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(q.value0);
          };
          if (q instanceof SetSelection) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
                  var v1 = TextSelection.setSelection("text-display-component", v.selectionStart, v.selectionEnd);
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(q.value0);
              });
          };
          if (q instanceof Paste) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(q.value0))(function (v) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Console.log(v)))(function () {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(pasteState(v1)(q.value1)(q.value2)(v)))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(TextChanged.value))(function () {
                                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(q.value3);
                              });
                          });
          ...
          if (q instanceof Cut) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))((function () {
                      if (q.value0 instanceof Data_Maybe.Just) {
                          return Web_HTML_Event_DataTransfer.setData(Data_MediaType_Common.textPlain)(WhatUtils.copyString(v.text)(q.value1)(q.value2))(q.value0.value0);
                      };
                      if (q.value0 instanceof Data_Maybe.Nothing) {
                          return Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit);
                      };
                      throw new Error("Failed pattern match at TextDisplay (line 151, column 30 - line 153, column 41): " + [ q.value0.constructor.name ]);
                  })()))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(cutState(v)(q.value1)(q.value2)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(TextChanged.value))(function () {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(q.value3);
                          });
                      });
          ...
          if (q instanceof HandleTripleClick) {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(q.value0(Halogen_Query_EventSource.Listening.value));
          };
          throw new Error("Failed pattern match at TextDisplay (line 106, column 18 - line 158, column 41): " + [ q.constructor.name ]);
      };
      return Halogen_Component.lifecycleParentComponent(ordTextLineSlot)({
          initialState: Data_Function["const"](initialState),
          render: render,
          "eval": $$eval,
          receiver: Data_Function["const"](Data_Maybe.Nothing.value),
  ...
  exports["UnmodifiedKeyDown"] = UnmodifiedKeyDown;
  exports["GeneralKeyDown"] = GeneralKeyDown;
  ...
  exports["NonprintableKey"] = NonprintableKey;
  exports["LineSlot"] = LineSlot;
  exports["component"] = component;
  exports["newStateFromPrintable"] = newStateFromPrintable;
  exports["newStateFromNonprintable"] = newStateFromNonprintable;
  exports["arrowUpState"] = arrowUpState;
  exports["arrowDownState"] = arrowDownState;
  exports["arrowLeftState"] = arrowLeftState;
  exports["arrowRightState"] = arrowRightState;
  exports["backspaceState"] = backspaceState;
  exports["deleteState"] = deleteState;
  exports["pasteState"] = pasteState;
  exports["cutState"] = cutState;
  exports["eqTextLineSlot"] = eqTextLineSlot;
  exports["ordTextLineSlot"] = ordTextLineSlot;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.0
  "use strict";
  $PS["TextEditor"] = $PS["TextEditor"] || {};
  var exports = $PS["TextEditor"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Eq = $PS["Data.Eq"];
  var Data_Function = $PS["Data.Function"];
  ...
  var Halogen_Query = $PS["Halogen.Query"];
  var Halogen_Query_HalogenM = $PS["Halogen.Query.HalogenM"];
  var TextDisplay = $PS["TextDisplay"];
  var WhatUtils = $PS["WhatUtils"];                
  var TextSlot = (function () {
      function TextSlot() {

      };
      TextSlot.value = new TextSlot();
      return TextSlot;
  })();
  var NoneQuery = (function () {
      function NoneQuery(value0) {
          this.value0 = value0;
      };
      NoneQuery.create = function (value0) {
          return new NoneQuery(value0);
      };
      return NoneQuery;
  })();
  var HandleTextDisplay = (function () {
      function HandleTextDisplay(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      HandleTextDisplay.create = function (value0) {
          return function (value1) {
              return new HandleTextDisplay(value0, value1);
          };
      };
      return HandleTextDisplay;
  })();
  var eqTextSlot = new Data_Eq.Eq(function (x) {
      return function (y) {
          return true;
      };
  });
  var ordTextSlot = new Data_Ord.Ord(function () {
      return eqTextSlot;
  }, function (x) {
      return function (y) {
          return Data_Ordering.EQ.value;
  ...
  var component = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div([ WhatUtils.classes([ "text-editor-component" ]) ])([ Halogen_HTML.slot(TextSlot.value)(TextDisplay.component)("")(Halogen_HTML_Events.input(HandleTextDisplay.create)) ]);
      };
      var $$eval = function (q) {
          if (q instanceof NoneQuery) {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(q.value0);
          };
          if (q instanceof HandleTextDisplay) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)((function () {
                  if (q.value0 instanceof TextDisplay.TextChanged) {
                      return Halogen_Query.query(eqTextSlot)(TextSlot.value)(Halogen_Query.action(TextDisplay.SetSelection.create));
                  };
                  if (q.value0 instanceof TextDisplay.NonprintableKey) {
                      return Halogen_Query.query(eqTextSlot)(TextSlot.value)(Halogen_Query.action(TextDisplay.SetSelection.create));
                  };
                  throw new Error("Failed pattern match at TextEditor (line 68, column 22 - line 70, column 104): " + [ q.value0.constructor.name ]);
              })())(function (v) {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(q.value1);
              });
          };
          throw new Error("Failed pattern match at TextEditor (line 65, column 18 - line 71, column 26): " + [ q.constructor.name ]);
      };
      return Halogen_Component.parentComponent(ordTextSlot)({
  ...
  exports["NoneQuery"] = NoneQuery;
  exports["HandleTextDisplay"] = HandleTextDisplay;
  exports["TextSlot"] = TextSlot;
  exports["component"] = component;
  exports["eqTextSlot"] = eqTextSlot;
  exports["ordTextSlot"] = ordTextSlot;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.0
  "use strict";
  ...
  var Halogen_HTML_Elements = $PS["Halogen.HTML.Elements"];
  var Halogen_Query_HalogenM = $PS["Halogen.Query.HalogenM"];
  var TextEditor = $PS["TextEditor"];
  var WhatUtils = $PS["WhatUtils"];
  var menuSlot = Halogen_Component_ChildPath.cp1;
  var bodySlot = Halogen_Component_ChildPath.cp2;
  var component = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div([ WhatUtils.classes([ "app-component" ]) ])([ Halogen_HTML_Elements.div([ WhatUtils.classes([ "app-header" ]) ])([ Halogen_HTML["slot'"](menuSlot)(Data_Unit.unit)(ActionMenu.component)(Data_Unit.unit)(Data_Function["const"](Data_Maybe.Nothing.value)) ]), Halogen_HTML_Elements.div([ WhatUtils.classes([ "app-body" ]) ])([ Halogen_HTML["slot'"](bodySlot)(Data_Unit.unit)(TextEditor.component)("")(Data_Function["const"](Data_Maybe.Nothing.value)) ]) ]);
      };
      var $$eval = function (q) {
          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(q.value0);
      };
      ...
      return function (ref) {
          return function (message) {
              return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Ref.read(ref)))(function (v) {
                  ...
                  throw new Error("Failed pattern match at Halogen.Aff.Driver.Eval (line 171, column 3 - line 175, column 62): " + [ v.constructor.name ]);
              });
          };
      };
  };
              ...
              return function (v) {
                  ...
                  if (v instanceof Halogen_Query_HalogenM.Par) {
                      return Control_Parallel_Class.sequential(Effect_Aff.parallelAff)(Control_Applicative_Free.retractFreeAp(Effect_Aff.applicativeParAff)(Control_Applicative_Free.hoistFreeAp((function () {
                          var $103 = Control_Parallel_Class.parallel(Effect_Aff.parallelAff);
                          var $104 = evalM(ref);
                          return function ($105) {
                              return $103($104($105));
                          };
              ...
              var handlePending = function (ref) {
                  return function __do() {
                      ...
                      return Data_Foldable.for_(Effect.applicativeEffect)(Data_Foldable.foldableMaybe)(v)((function () {
                          var $63 = Data_Foldable.traverse_(Effect_Aff.applicativeAff)(Data_List_Types.foldableList)(Control_Monad_Fork_Class.fork(Control_Monad_Fork_Class.monadForkAff));
                          return function ($64) {
                              return handleAff($63(Data_List.reverse($64)));
                          };
                      })())();
                  };
              };
              var cleanupSubscriptions = function (v) {
                  return function __do() {
                      Control_Bind.bindFlipped(Effect.bindEffect)(Data_Foldable.traverse_(Effect.applicativeEffect)(Data_Foldable.foldableMaybe)((function () {
                          var $65 = Data_Foldable.traverse_(Effect_Aff.applicativeAff)(Data_Map_Internal.foldableMap)(Control_Monad_Fork_Class.fork(Control_Monad_Fork_Class.monadForkAff));
                          return function ($66) {
                              return handleAff($65($66));
                          };
              ...
              var squashChildInitializers = function (lchs) {
                  return function (preInits) {
                      return Halogen_Aff_Driver_State.unDriverStateX(function (st) {
                          var parentInitializer = Data_Functor.map(Data_Maybe.functorMaybe)((function () {
                              var $67 = evalF(st.selfRef);
                              return function ($68) {
                                  return $67(Halogen_Query_InputF.Query.create($68));
                              };
                                                              ...
                                                              var v1 = (function () {
                                                                  ...
                                                                  if (v1 instanceof Data_Maybe.Just) {
                                                                      ...
                                                                      Data_Foldable.for_(Effect.applicativeEffect)(Data_Foldable.foldableMaybe)(inputQuery(input))(function (q) {
                                                                          return function __do() {
                                                                              ...
                                                                              return Halogen_Aff_Driver_State.unDriverStateX(function (st) {
                                                                                  return Data_Foldable.for_(Effect.applicativeEffect)(Data_Foldable.foldableMaybe)(st.prjQuery(q))((function () {
                                                                                      var $71 = evalF(st.selfRef);
                                                                                      return function ($72) {
                                                                                          return handleAff($71(Halogen_Query_InputF.Query.create($72)));
                                                                                      };
                                                                                  })());
                                                                              })(v2)();
                                                                          };
                                                                  ...
                                                                  if (v1 instanceof Data_Maybe.Nothing) {
                                                                      return runComponent(lchs)((function () {
                                                                          var $73 = Data_Maybe.maybe(Control_Applicative.pure(Effect_Aff.applicativeAff)(Data_Unit.unit))(handler);
                                                                          return function ($74) {
                                                                              return $73(outputQuery($74));
                                                                          };
                                                                      })())(input)(prjQuery)(ctor)();
                                                                  };
              ...
              var render = function (lchs) {
                  return function ($$var) {
                      return function __do() {
                          ...
                          var handler = Halogen_Aff_Driver_Eval.queuingHandler((function () {
                              var $75 = Data_Functor["void"](Effect_Aff.functorAff);
                              var $76 = evalF(v.selfRef);
                              return function ($77) {
                                  return $75($76($77));
                              };
                          })())(v.pendingHandlers);
                          var childHandler = Halogen_Aff_Driver_Eval.queuingHandler(function ($78) {
                              return handler(Halogen_Query_InputF.Query.create($78));
                          })(v.pendingQueries);
                          var v2 = renderSpec.render(function ($79) {
                              return handleAff(handler($79));
                          ...
                          return Control_Applicative.when(Effect.applicativeEffect)(v1)(Data_Function.flip(Control_Monad_Rec_Class.tailRecM(Control_Monad_Rec_Class.monadRecEffect))(Data_Unit.unit)(function (v4) {
                              return function __do() {
                                  ...
                                  Data_Foldable.traverse_(Effect.applicativeEffect)(Data_Foldable.foldableMaybe)((function () {
                                      var $80 = Data_Foldable.traverse_(Effect_Aff.applicativeAff)(Data_List_Types.foldableList)(Control_Monad_Fork_Class.fork(Control_Monad_Fork_Class.monadForkAff));
                                      return function ($81) {
                                          return handleAff($80(Data_List.reverse($81)));
                                      };
                                  })())(v5)();
              ...
              var finalize = function (lchs) {
                  return Halogen_Aff_Driver_State.unDriverStateX(function (st) {
                      return function __do() {
                          ...
                          Data_Foldable.for_(Effect.applicativeEffect)(Data_Foldable.foldableMaybe)(Data_Functor.map(Data_Maybe.functorMaybe)((function () {
                              var $82 = evalF(st.selfRef);
                              return function ($83) {
                                  return $82(Halogen_Query_InputF.Query.create($83));
                              };
...
(function($PS) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitLoad)(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.selectElement("#app"))(Data_Foldable.traverse_(Effect_Aff.applicativeAff)(Data_Foldable.foldableMaybe)(function (container) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_VDom_Driver.runUI(App.component)(Data_Unit.unit)(container))(function (v) {
