...
(function($PS) {
  ...
  var KeyDown = (function () {
      function KeyDown(value0, value1, value2, value3) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
          this.value3 = value3;
      ...
      KeyDown.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return function (value3) {
                      return new KeyDown(value0, value1, value2, value3);
                  };
              };
          };
      };
          ...
          return function (end) {
              return function (nonprintable) {
                  ...
                  if (nonprintable === "Delete") {
                      ...
                      var $36 = end < Data_String_CodePoints.length(state.text);
                      if ($36) {
                          return newState;
                      };
                      return newState;
  ...
  var component = (function () {
      ...
      var handleKeyDown = function (event) {
          ...
          return KeyDown.create(key)(Data_Ord.min(Data_Ord.ordInt)(start)(end))(Data_Ord.max(Data_Ord.ordInt)(start)(end));
      };
      var render = function (state) {
      ...
      var $$eval = function (q) {
          if (q instanceof KeyDown) {
              var $38 = WhatUtils.isPrintable(q.value0);
              if ($38) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
                      var newText = WhatUtils.constructNewText(v.text)(q.value1)(q.value2)(q.value0);
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Console.log("newText: " + newText)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)({
                              text: newText,
                              selectionStart: q.value1 + 1 | 0,
                              selectionEnd: q.value1 + 1 | 0
                          }))(function () {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Console.log("nonprintable: " + q.value0)))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
          ...
          if (q instanceof SetSelection) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Console.log("WHATO")))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
