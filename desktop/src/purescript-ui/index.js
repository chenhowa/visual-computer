...
(function($PS) {
  ...
  var isPrintable = function (str) {
      ...
      var $9 = Data_String_CodePoints.length(str) === 1;
      if ($9) {
          return true;
      };
      var $10 = isNotPrintable(str);
      if ($10) {
          return false;
      };
      return true;
      ...
      return function (start) {
          return function (end) {
              ...
              if ($12) {
                  ...
                  var $13 = start > Data_String_CodePoints.length(full) || end < 0;
                  if ($13) {
                      return full;
                  };
...
(function($PS) {
  ...
  var getArrowUpState = function (state) {
      return function (start) {
          return function (end) {
              var before = (Data_String_CodePoints.splitAt(start)(state.text)).before;
              var maybeLastIndex = Data_String_CodePoints.lastIndexOf("\x0a")(before);
              var maybePreviousIndex = (function () {
                  if (maybeLastIndex instanceof Data_Maybe.Nothing) {
                      return new Data_Maybe.Just(0);
                  };
                  if (maybeLastIndex instanceof Data_Maybe.Just) {
                      return Data_String_CodePoints.lastIndexOf("\x0a")((Data_String_CodePoints.splitAt(maybeLastIndex.value0)(before)).before);
                  };
                  throw new Error("Failed pattern match at TextDisplay (line 185, column 30 - line 187, column 84): " + [ maybeLastIndex.constructor.name ]);
              })();
              var offset = (function () {
                  if (maybeLastIndex instanceof Data_Maybe.Nothing) {
                      return 0;
                  ...
                  if (maybeLastIndex instanceof Data_Maybe.Just) {
                      return Data_String_CodePoints.length(before) - maybeLastIndex.value0 | 0;
                  };
                  throw new Error("Failed pattern match at TextDisplay (line 182, column 18 - line 184, column 50): " + [ maybeLastIndex.constructor.name ]);
              })();
              var newStart = (function () {
                  if (maybePreviousIndex instanceof Data_Maybe.Nothing) {
                      return Data_Ord.max(Data_Ord.ordInt)(offset - 1 | 0)(0);
                  };
                  if (maybePreviousIndex instanceof Data_Maybe.Just && maybePreviousIndex.value0 === 0) {
                      return 0;
                  };
                  if (maybePreviousIndex instanceof Data_Maybe.Just) {
                      if (maybeLastIndex instanceof Data_Maybe.Nothing) {
                          return maybePreviousIndex.value0 + offset | 0;
                      };
                      if (maybeLastIndex instanceof Data_Maybe.Just) {
                          return Data_Ord.min(Data_Ord.ordInt)(maybeLastIndex.value0)(maybePreviousIndex.value0 + offset | 0);
                      };
                      throw new Error("Failed pattern match at TextDisplay (line 191, column 27 - line 193, column 65): " + [ maybeLastIndex.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at TextDisplay (line 188, column 20 - line 193, column 65): " + [ maybePreviousIndex.constructor.name ]);
              })();
              return {
                  text: state.text,
  ...
  var getArrowDownState = function (state) {
      return function (start) {
          return function (end) {
              var split = Data_String_CodePoints.splitAt(end)(state.text);
              var maybeLastNewlineIndex = Data_String_CodePoints.lastIndexOf("\x0a")(split.before);
              var offset = (function () {
                  if (maybeLastNewlineIndex instanceof Data_Maybe.Nothing) {
                      return end;
                  };
                  if (maybeLastNewlineIndex instanceof Data_Maybe.Just) {
                      return Data_String_CodePoints.length(split.before) - maybeLastNewlineIndex.value0 | 0;
                  };
                  throw new Error("Failed pattern match at TextDisplay (line 206, column 18 - line 208, column 50): " + [ maybeLastNewlineIndex.constructor.name ]);
              })();
              var maybeNextNewlineIndex = Data_String_CodePoints.indexOf("\x0a")(split.after);
              var newEnd = (function () {
                  if (maybeNextNewlineIndex instanceof Data_Maybe.Nothing) {
                      return Data_String_CodePoints.length(state.text);
                  };
                  if (maybeNextNewlineIndex instanceof Data_Maybe.Just) {
                      return maybeNextNewlineIndex.value0 + offset | 0;
                  };
                  throw new Error("Failed pattern match at TextDisplay (line 210, column 18 - line 212, column 43): " + [ maybeNextNewlineIndex.constructor.name ]);
              })();
              return {
                  text: state.text,
          ...
          return function (end) {
              return function (nonprintable) {
                  if (nonprintable === "ArrowRight") {
                      var $35 = start === end;
                      if ($35) {
                          var $36 = start < Data_String_CodePoints.length(state.text);
                          if ($36) {
                              return {
                                  text: state.text,
                                  selectionStart: start + 1 | 0,
                                  selectionEnd: end + 1 | 0
                              };
                          };
                          return state;
                      };
                  ...
                  if (nonprintable === "ArrowUp") {
                      return getArrowUpState(state)(start)(end);
                  };
                  if (nonprintable === "ArrowDown") {
                      return getArrowDownState(state)(start)(end);
                  };
                  ...
                  if (nonprintable === "Delete") {
                      ...
                      var $42 = end < Data_String_CodePoints.length(state.text);
                      if ($42) {
                          return newState;
                      };
                      return newState;
  ...
  var component = (function () {
      ...
      var $$eval = function (q) {
          if (q instanceof KeyDown) {
              var $52 = WhatUtils.isPrintable(q.value0);
              if ($52) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
          ...
          throw new Error("Failed pattern match at TextDisplay (line 94, column 18 - line 125, column 26): " + [ q.constructor.name ]);
      };
  ...
  exports["getArrowUpState"] = getArrowUpState;
  exports["getArrowDownState"] = getArrowDownState;
